export const rpcList = [
  ...
  },
  {
    ...
    rpc: ['https://rpc.merlinchain.io', 'https://merlin-mainnet-enterprise.unifra.io', 'https://rpc-merlin.rockx.com'],
    faucets: [],
  ...
  },
  {
    ...
    rpc: [
      ...
      'https://linea-sepolia.infura.io/v3',
      'wss://linea-sepolia.infura.io/ws/v3',
    ],
    faucets: [],
    infoURL: 'https://linea.build',
  },
  ...
  },
  {
    ...
    rpc: ['https://public-node.api.boraportal.com/bora/mainnet', 'https://public-node.api.boraportal.io/bora/mainnet'],
    faucets: [],
  ...
  },
  {
    ...
    rpc: ['https://bartio.rpc.berachain.com', 'https://bera-testnet.nodeinfra.com', 'https://bartio.rpc.b-harvest.io'],
  ...
  },
  {
    ...
    rpc: ['https://sepolia-rollup.arbitrum.io/rpc', 'https://arbitrum-sepolia.infura.io/v3'],
    faucets: [],
    infoURL: 'https://arbitrum.io',
  },
  {
  ...
  },
  {
    ...
    rpc: ['https://palm-testnet.infura.io/v3', 'https://palm-testnet.public.blastapi.io'],
    faucets: [],
  ...
  },
  {
    ...
    rpc: ['https://palm-mainnet.infura.io/v3', 'https://palm-mainnet.public.blastapi.io'],
    faucets: [],
    infoURL: 'https://palm.network',
  },
  {
